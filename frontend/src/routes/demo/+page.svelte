<script lang="ts">
	...
	let scrollY = 0;
	console.log($page.url.searchParams.get('data'))
	const generateDemoContestData = () => {
		return demo.get($page.url.searchParams.get('data'))
	};
	$contest = generateDemoContestData();
